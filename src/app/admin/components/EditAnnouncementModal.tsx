        ...
        <div className="relative w-[48rem] my-6 mx-auto max-w-3xl">
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
              ...
              <button
                className="z-[999] p-1 ml-auto bg-transparent border-0 text-black float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
            ...
            <div className="relative p-6 flex-auto">
              <textarea
                ...
                className="my-4 text-blueGray-500 min-w-full text-lg leading-relaxed border-2 p-2"
              ></textarea>
            </div>
